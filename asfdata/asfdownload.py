...
#
#       python ./download-all-2019-09-12_16-51-52.py
#
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#
#       python ./download-all-2019-09-12_16-51-52.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
#
...
#        self.files = [ "https://datapool.asf.alaska.edu/RAW/SA/S1A_IW_RAW__0SDV_20190910T142325_20190910T142357_028960_0348C3_E836.zip" ]
        self.files = []  #filelist
        ...
        if len(sys.argv) > 0:
            ...
            for arg in sys.argv[1:]:
                ...
                elif arg.endswith('.metalink') or arg.endswith('.csv') or arg.endswith('.list'):
                    if os.path.isfile( arg ):
                        ...
                        if arg.endswith('.list'):
                           ...
                           for i in range(len(filelist)):
                              scene=filelist[i].rstrip()
                              if scene.startswith('S1A'):
                                  filelist[i]="https://datapool.asf.alaska.edu/RAW/SA/"+scene
                              if scene.startswith('S1B'):
                                  filelist[i]="https://datapool.asf.alaska.edu/RAW/SB/"+scene
                           print ("files: ")
                           print (filelist)
