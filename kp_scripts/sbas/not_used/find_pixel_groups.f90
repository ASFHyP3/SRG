...
PROGRAM find_pixel_groups
  ...
  INTEGER:: nslc
  INTEGER*8::nr,naz
  CHARACTER(100)::geolist,scenemask
  ...
  IF(iargc().lt.4)THEN
     WRITE(*,*)'usage: find_pixel_groups geolist nslc nr naz <scenemask=none>'
     STOP
  END IF
