...
##### ----- GENERATE A NEW DEM.RSC FILE FOR MULTILOOKED AND/OR EXTRACTED PORTION ----- #####
if os.path.isfile('dem.rsc') == False:
    command = '$PROC_HOME/kp_scripts/util/make_ml_demrsc.py '+demrscfile+' '+xstart+' '+ystart+' '+xsize+' '+ysize+' '+xlooks+' '+ylooks
    print('\n    '+command)
