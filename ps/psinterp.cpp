...
int main(int argc, char *argv[]){
    const std::string ifgfile = "20170213_20180115.int";
    const std::string psfile = "all_similarity_mask";
    const std::string outputfile = "20170213_20180115.interp.int";
