...
16    continue
	...
	real*4        vpp(3)
	integer*4     ia,ir,i,j,jj,lref,lrefp,nn,l1,l2
	real*4        wgth,fi_p,fi_y,r,fi,sin_sq
	real*4        frq,f_est,a0,a1,a2,ff,fl
	real*4        f_d(N_RA),f_dopp(20)
c	real*4        f_dhr(N_RA),f_inuhr(N_RA),f_dopphr(N_RA)
	real*4        f0,f1,f2,pi
	complex*8     dbuf(N_RA)
        integer*4     rinc
        data pi /3.141592653/ 
