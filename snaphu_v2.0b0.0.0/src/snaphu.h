...
typedef struct boundaryST{
  ...
  neighborT* neighborlist;      /* list of neighbors */
  nodeT **boundarylist;         /* list of boundary nodes */
  long nneighbor;               /* number of neighbor nodes */
  long nboundary;               /* number of nodes pointing to boundary */
}boundaryT;
