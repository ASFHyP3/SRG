c  cmb2float2rg - combine 2 float pictures to an rg image
      ...
      complex in1(65536),in2(65536)
      complex rg(65536)
      character*60 file

      if(iargc().le.3)then
         write(6,*)'usage: cmb2cpx2rg infile 1(cpx, mag)  infile 2  outfile  length'
         stop
      end if
      ...
      call getarg(2,file)
      open(22,file=file,access='direct',recl=len*8)
      call getarg(3,file)
      ...
      do line=1,100000
         ...
         do i=1,len
            rg(i)=cmplx(cabs(in1(i)),cabs(in2(i)))
         end do
