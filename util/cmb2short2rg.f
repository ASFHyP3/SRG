c  cmb2short2rg - combine 2 short integer pictures to an rg image

      integer*2 in1(65536),in2(65536)
      complex rg(65536)
      character*60 file
      ...
      call getarg(2,file)
      open(22,file=file,access='direct',recl=len*2)
      call getarg(3,file)
      ...
      do line=1,100000
         ...
         do i=1,len
            rg(i)=cmplx(float(in1(i)),float(in2(i)))
         end do
