c  curveearthroi.f -- alternate derivation of curved earth phase
...
c   if dem file doesn't exist, use flat earth
      ...
      real*4 dem(10000),indat(10000),dem2(10000)
      dimension a(3)
...
c            if(j.eq.1)print *,rho,theta,re,h,dem(j+len)
            ...
            dem2(j+len)=-4.*3.14159265/wvl*(a(1)**2/2/rho-a(1)*sinthetaminusalpha)
            print *,rho,dem(j+len),-dem2(j+len)
         end do
