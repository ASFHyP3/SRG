	...
	real*8	easting(100),northing(100),lat(100),long(100),dlat,dlon
	character*30 f
	...
	if(iargc().lt.6)then
	   print *,'usage: demposting ul-lat ul-lon deltalat deltalon xsize ysize'
	   stop
	end if
	...
	print *,'Lat. posting: ',(tx(2)-tx(1))/(nx-1)
	print *,'Lon. posting: ',(ty(2)-ty(1))/(ny-1)
